<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterPage.aspx.cs" Inherits="SEALevel1.Views.RegisterPage" %>
    ...
    <section class="container">
        ...
        <form class="form" runat="server">
            ...
            <div class="input-box">
                ...
                <div class="input-box">
                <asp:Label class="label" ID="PhoneNumberLbl" runat="server" Text="Phone Number"></asp:Label>
                <asp:TextBox ID="PhoneNumberTxt" placeholder="Enter Phone Number" runat="server"></asp:TextBox>
            </div>
