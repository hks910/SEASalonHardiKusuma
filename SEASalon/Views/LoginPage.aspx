<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="SEALevel1.Views.LoginPage" %>
...
<body>
    <main>
        <h1 class="Title">SEA Salon</h1>
        <%--<img class="GymMe-Logo" src="<%= ResolveUrl("~/Styles/Img/GymMe-Logo-removebg.png") %>" />--%>

  <div class="vertical-container">
        <form class="form-div" runat="server">

            <img class="GymMe-Logo" src="../Styles/IMG/logo.png" />
            <div id="form-input">
                <h1 class="LoginTitle">Login</h1>

                <asp:TextBox class="input" ID="PhoneNumberTxt" placeholder="PhoneNumber" runat="server"></asp:TextBox>
